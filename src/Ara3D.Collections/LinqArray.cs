...
namespace Ara3D.Collections
{
    ...
    public static class LinqArray
    {
        ...
        public static Ara3D.Collections.ILookup<TKey, TValue> ToLookup<TSource, TKey, TValue>(this IArray<TSource> input, Func<TSource, TKey> keyFunc, Func<TSource, TValue> valueFunc)
        ...
        public static Ara3D.Collections.ILookup<TKey, TSource> ToLookup<TSource, TKey>(this IArray<TSource> input, Func<TSource, TKey> keyFunc)
