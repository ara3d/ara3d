...
namespace Ara3D.Mathematics
{
    public static partial class MathOps
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static double Pow(this double x, double y) => System.Math.Pow(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static float Atan2(this float x, float y) => (float)System.Math.Atan2(x, y);
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static float Log(this float x, float y) => (float)System.Math.Log(x, y);
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static float Pow(this float x, float y) => (float)System.Math.Pow(x, y);
