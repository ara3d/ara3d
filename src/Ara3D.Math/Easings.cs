...
namespace Ara3D.Mathematics
{
    public static class Easings
    {
        ...
        public const float HALFPI = Constants.HalfPi;
        ...
        ///     y = (1/2)(1 - (float)System.Math.Sqrt(1 - 4x^2))           ; [0, 0.5)
        ///     y = (1/2)((float)System.Math.Sqrt(-(2x - 3)*(2x - 1)) + 1) ; [0.5, 1]
        /// </summary>
        ...
        ///     y = (1/2)*sin(13pi/2*(2*x))*(float)System.Math.Pow(2, 10 * ((2*x) - 1))      ; [0,0.5)
        ///     y = (1/2)*(sin(-13pi/2*((2x-1)+1))*(float)System.Math.Pow(2,-10(2*x-1)) + 2) ; [0.5, 1]
        /// </summary>
