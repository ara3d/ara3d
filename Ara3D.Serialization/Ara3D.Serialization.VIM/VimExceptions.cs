...
namespace Ara3D.Serialization.VIM
{
    ...
    /// HResult values can be returned as program exit codes to indicate the cause for failure.
    /// </summary>
    public class HResultException : Exception
    {
        public HResultException(int errorCode, string message = null, Exception innerException = null)
    ...
    {
        VimDataFormatError =
            unchecked((int)(HResult.CustomFailureMask | 0x00003000)), // starting error code range at 0xA0003000.
